...
export const saveFrontendUserData = async <UserDataKey extends ValidUserDataKey>(
  conn: Connection,
  key: UserDataKey,
...
export const fetchFrontendSystemData = async <SystemDataKey extends ValidSystemDataKey>(
  conn: Connection,
  key: SystemDataKey
...
export const saveFrontendSystemData = async <SystemDataKey extends ValidSystemDataKey>(
  conn: Connection,
  key: SystemDataKey,
...
export const subscribeFrontendSystemData = <SystemDataKey extends ValidSystemDataKey>(
  conn: Connection,
